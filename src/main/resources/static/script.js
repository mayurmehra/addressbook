...
const clearForm = function (ev) {
    ev.preventDefault();
    console.log("Clearing the form", document.getElementById("inputId").value);
    document.getElementById("form").reset();
    document.getElementById("inputId").value = '';
    document.getElementById("deleteButton").disabled = true; // Disable delete button after clearing the form
}
